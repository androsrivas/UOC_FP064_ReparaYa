<x-layouts.app>
    ...
    <header class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <div>
            <a href="{{ route('incidencias.create') }}"
                class="inline-block rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-800">
                + Nueva Incidencia
            </a>
        </div>
    </header>
    ...
    <div class="mb-4 flex items-center justify-between px-2">
        ...
        <a href="{{ route('incidencias.index') }}"
            class="rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 transition-colors hover:border-blue-400 hover:text-blue-600 shadow-sm">
            Ver todas
        </a>
    </div>
